...
INSERT INTO carreras (
	...
	VALUES	(
		...
		(
		"Les Deux Alpes Night Snow Trail :5, 10,15 et 20 km", 33, "Isère, Les Deux Alpes ", null, null, 20000, '{"subida":600,"bajada":"-"}', "2024-01-13", false, null, null, '{"latitud":45.012284,"longitud":6.124414}', null, null, "http://www.les2alpes.com/", 'https://via.placeholder.com/640x480.png/00cccc?text=praesentium'
		),
		(
		"Nájera Xtrem Cuna de Reyes - corta", 13, "La Rioja, Nájera", null, null, 11000, null, "2024-03-01", false, null, null, '{"latitud":42.417368,"longitud":-2.733225}', null, null, "https://clubdemontanak2.blogspot.com/2023/02/ya-tenemos-el-nuevo-cartel-de-la-najera.html", 'https://via.placeholder.com/640x480.png/00cccc?text=praesentium'
		),
		(
		"Ultra Fiord 16K", 8, "Torres del Paine", null, null, 16000, '{"subida":950,"bajada":"-"}', "2024-02-03", true, '["Servicio guardarropa","Prueba cronometrada con chip", "Bocadillos o comida a la llegada"]', null, null, null, null, "https://www.ultrafiord.com/es/", 'https://via.placeholder.com/640x480.png/00cccc?text=praesentium'
		),
		(
		"Express Trail Cap de Creus", 13, "Girona, Roses", "Roses", "Roses", 12000, '{"subida":600,"bajada":600}', "2024-03-09", true, '["Servicio guardarropa","Prueba cronometrada con chip", "Bocadillos o comida a la llegada", "Servicio de masaje", "Trofeo a los ganadores"]', '{"Altura max.":470,"Tiempo max.":"4h","Avituallamientos":1,"% asfalto":10,"% pista o camino tierra":5,"% senderos":85}', '{"latitud":42.26430367,"longitud":3.173959851}', null, 50.00, "https://www.klassmark.com/trailcapdecreus/", 'https://via.placeholder.com/640x480.png/00cccc?text=praesentium'
		),
		(
		"Camí dels ibers Marató ", 11, "Barcelona, La Roca del Vallès", "Plaça de Can Torrents", "Plaça de Can Torrents", 42000, '{"subida":1300,"bajada":1300}', "2024-03-17", true, '["Servicio guardarropa","Prueba cronometrada con chip", "Carrera infantil", "Bocadillos o comida a la llegada", "Servicio de masaje", "Trofeo a los ganadores", "Sorteo de premios"]', '{"Altura max.":520,"Tiempo max.":"5h30","Avituallamientos":13,"% asfalto":1,"% pista o camino tierra":7,"% senderos":92}', '{"latitud":41.587174,"longitud":2.325998}', 300, 28.00, "http://www.elsibers.cat/inscripcions/", 'https://via.placeholder.com/640x480.png/00cccc?text=praesentium'
		),
		(
		"Trail del Serrucho ", 11, "Madrid, Alalpardo", "Plaza de Toros de Alalpardo", "Plaza de Toros de Alalpardo", 14200, '{"subida":240,"bajada":240}', "2024-01-14", true, '["Servicio guardarropa","Prueba cronometrada con chip", "Carrera infantil", "Bocadillos o comida a la llegada", "Servicio de masaje", "Trofeo a los ganadores", "Sorteo de premios"]', '{"Altura max.":789,"Tiempo max.":"2h","Avituallamientos":5,"% asfalto":5,"% pista o camino tierra":5,"% senderos":90}', '{"latitud":40.62859500784598,"longitud":-3.4727277073887217}', 800, 16.00, "https://inscripcionesdeportivas.timinglap.com/inscripcion/trail-del-serrucho-11/", 'https://via.placeholder.com/640x480.png/00cccc?text=praesentium'
		);
